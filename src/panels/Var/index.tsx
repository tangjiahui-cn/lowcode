...
import { engine, GlobalVariable, EVENT } from '@/core';
...
export default function () {
  ...
  function save(list: GlobalVariable[]) {
    ...
    if (pageJsonNode) {
      ...
      engine.jsonNode.update(pageJsonNode.id, pageJsonNode);
    }
  }
  ...
  useEffect(() => {
    ...
    engine.event.on(EVENT.globalVar, updateList);
    return () => {
      engine.event.remove(EVENT.globalVar, updateList);
    };
  }, []);
