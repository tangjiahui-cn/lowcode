...
import { Component, Instance, JsonNode, runtime, useFlow } from '@/engine';
...
export default function () {
  ...
  useFlow('jsonNode-select', ({ data: jsonNode }) => {
    setJsonNode(jsonNode);
    setComponent(runtime.components.get(jsonNode?.cId));
    setInstance(runtime.instances.get(jsonNode?.id));
    setActiveKey('1');
  });
